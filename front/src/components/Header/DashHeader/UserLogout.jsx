            ...
            <section className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 text-white">
                <div className="p-6 border rounded-lg shadow-lg max-w-sm w-full text-center">
                    ...
                    <div className="flex gap-4 justify-center">
                        <div>
                            <button onClick={logoutU} className="bg-red-400  px-4 py-2 rounded hover:bg-red-500">
                                Yes
                            </button>
                        </div>

                        <div>
                            <button onClick={notToShow()} className="bg-blue-400 px-4 py-2 rounded hover:bg-blue-500">
                                No
                            </button>
                        </div>
                    </div>
