...
function EditIncome({ isOpen, onToggle, incomeId }) {
  return (
    <section className="border border-yellow-500 bg-[#020b33] rounded-[20px] p-8 mt-5 w-[350px]">
      <div className="flex justify-between items-center mb-4">
        <p className="text-white text-[1.2rem]">Edit Income</p>

        <button
          type="button"
          className="flex items-center gap-2 py-1 px-3 bg-yellow-600 hover:bg-yellow-700 text-white rounded-[6px]"
          onClick={onToggle}
        >
