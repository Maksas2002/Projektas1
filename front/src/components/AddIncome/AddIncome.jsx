...
function AddIncome({ isOpen, onToggle }) { 
  return (
    <section className="border border-green-500 bg-[#020b33] rounded-[20px] p-8 mt-5 w-87.5">
      <div className="flex justify-between items-center mb-4">
        <p className="text-white text-[1.2rem]">Add Income</p>
        <button
          type="button"
          className="flex items-center gap-2 py-1 px-3 bg-green-600 hover:bg-green-700 text-white rounded-md"
          onClick={onToggle}
        >
